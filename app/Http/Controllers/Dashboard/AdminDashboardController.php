...
class AdminDashboardController extends Controller
{
    public function index()
    {
        ...
        $totalIncome =
            ...
            DB::table('cucian_motor_orders')->whereIn('status',['selesai','diambil'])->sum('total');
        ...
        $currentMonthIncome =
            ...
            DB::table('cucian_motor_orders')->whereMonth('order_date', $today->month)->whereIn('status',['selesai','diambil'])->sum('total');
        ...
        $lastMonthIncome =
            ...
            DB::table('cucian_motor_orders')->whereMonth('order_date', $today->copy()->subMonth()->month)->whereIn('status',['selesai','diambil'])->sum('total');
        ...
        for($i=0;$i<7;$i++){
            ...
            $dayIncome =
                ...
                DB::table('cucian_motor_orders')->whereDate('order_date',$date)->whereIn('status',['selesai','diambil'])->sum('total');
