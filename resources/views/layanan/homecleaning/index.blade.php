...
@php
function homeCleaningIcon($category) {
    $c = strtolower($category);

    return match (true) {
        str_contains($c, 'pembersihan')         => 'fa-house',
        str_contains($c, 'jasa kebersihan')         => 'fa-broom',
...
<section class="service-hero">
  <div class="container">
    <span class="hero-badge">
      <i class="fa-solid fa-broom"></i> Home Cleaning
    </span>

    <h1>Rumah Bersih <br><span>Tanpa Ribet</span></h1>
    <p>Layanan kebersihan rumah profesional & terpercaya</p>
  </div>
</section>
  ...
  <div class="container service-grid">
    ...
    @foreach ($services as $category => $items)
      <div class="service-card category-card"
        ...
        <div class="icon">
          <i class="fa-solid {{ homeCleaningIcon($category) }}"></i>
        </div>
...
function getHomeCleaningIcon(category) {
  ...
  if (category.includes('pembersihan')) return 'fa-house';
  if (category.includes('jasa kebersihan')) return 'fa-broom';
