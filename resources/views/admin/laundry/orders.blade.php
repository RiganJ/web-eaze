...
<div class="order-wrapper">
  <div class="order-card">
    ...
    <div class="order-header">
      ...
      <!-- Tombol Tambah Order -->
      <a href="{{ route('admin.laundry.orders.create') }}" class="btn-modern btn-primary-modern">
...
<td class="action-cell">
    ...
    <!-- DETAIL -->
  <a href="{{ route('admin.laundry.orders.show', $o->id) }}"
    ...
    <!-- UPDATE STATUS -->
    <form method="POST"
        action="{{ route('admin.laundry.orders.status', $o->id) }}">
        @csrf
...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/laundry-orders.css') }}">
