...
@section('title','Detail Pesanan HomeClean')
  ...
  <div class="order-card">
    ...
    <div class="order-header">
      <div>
        ...
        <small>Invoice {{ $invoiceCode ?? $order->order_code }}</small>
      </div>
...
<a href="{{ route('admin.homecleaning.orders') }}" 
   class="btn-modern btn-outline-modern">
   <i class="fa-solid fa-arrow-left"></i>
   Kembali
</a>

        <a href="{{ route('admin.homecleaning.orders.sendWa', $order->id) }}"
   ...
   Cetak Struk
    ...
    <div class="receipt-page">
      <div class="receipt-container">
        ...
        @include('admin.homecleaning.partials.receipt')
