...
@section('title','Pesanan KarSoBed')
...
<div class="order-wrapper">
  <div class="order-card">
    ...
    <div class="order-header">
      <div>
        <h4>Pesanan KarSoBed</h4>
        <small>Daftar order masuk</small>
      </div>

      <!-- Tombol Tambah Order -->
      <a href="{{ route('karsobed.orders.create') }}" class="btn btn-primary">
        Tambah Order
      </a>
    </div>
        ...
        <table id="ordersTable" class="order-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <form method="POST"
                      action="{{ route('karsobed.orders.status', $o->id) }}">
                  @csrf
...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/karsobed-orders.css') }}">
