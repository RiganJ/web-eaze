...
@section('title', 'Tambah Pesanan Carwash')
@section('page-title', 'Tambah Pesanan Carwash')
...
<div class="order-page-created">
  ...
  <div class="order-card">
    ...
    <div class="order-card-header">
      <div>
        <h3>Tambah Pesanan Carwash</h3>
        <p>Input data pesanan Carwash customer</p>
      </div>

<a href="{{ route('carwash.orders') }}" 
   ...
   Kembali
    ...
    <form method="POST" action="{{ route('carwash.orders.store') }}" class="order-form">
      @csrf
