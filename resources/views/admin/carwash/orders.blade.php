...
@section('title','Pesanan Car Wash')
...
<div class="order-wrapper">
  <div class="order-card">
    ...
    <div class="order-header">
      <div>
        <h4>Pesanan Car Wash</h4>
        <small>Daftar order masuk</small>
      </div>

      <!-- Tombol Tambah Order -->
      <a href="{{ route('carwash.orders.create') }}" class="btn-modern btn-primary-modern">
...
<td class="action-cell">
    ...
    <!-- DETAIL -->
    <a href="{{ route('carwash.orders.show', $o->id) }}" 
    ...
    <!-- UPDATE STATUS -->
    <form method="POST"
          action="{{ route('carwash.orders.status', $o->id) }}">
        @csrf
...
@push('styles')
<link rel="stylesheet" href="{{ asset('css/carwash-orders.css') }}">
